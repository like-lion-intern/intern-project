...
def generate_final_report(date, results_dir=None, trajectory_file=None):
    ...
    try:
        ...
        output_file = os.path.join(results_dir, f"{date}_report.md")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--date", type=str, required=True, help="생성할 리포트의 기준 날짜 (예: 2026-02-05)")
    parser.add_argument("--results_dir", type=str, default=None, help="JSON 파일이 위치한 폴더 경로")
    parser.add_argument("--trajectory", type=str, default=None, help="특정 trajectory.json 파일 경로 지정")
    args = parser.parse_args()
    
    generate_final_report(args.date, results_dir=args.results_dir, trajectory_file=args.trajectory)
